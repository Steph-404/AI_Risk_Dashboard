          ...
          <AnimatePresence>
            {isSearchOpen && searchQuery.trim().length > 0 && (
              <motion.div
                ...
                className="absolute top-full left-0 right-0 mt-2 rounded-2xl glass-panel shadow-2xl overflow-hidden z-50"
              >
          ...
          <AnimatePresence>
            {isNotifOpen && (
              <motion.div
                ...
                transition={{ duration: 0.2 }}
                className="absolute top-full right-0 mt-2 w-80 sm:w-96 rounded-2xl glass-panel shadow-2xl overflow-hidden z-50 origin-top-right"
              >
